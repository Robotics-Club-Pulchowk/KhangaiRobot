...
void init_GameField()
{
        ...
        gStateB_Data.lower_bounds = Vec2<float>(1600, 1300);
        ...
        gStateD_Data.upper_bounds = Vec2<float>(900, 3100);
        gStateD_Data.lower_bounds = Vec2<float>(500, 2700);
        gStateD_Data.last_limit = 0;
        ...
        gStateF_Data.lower_bounds = Vec2<float>(1600, 3800);
        ...
        gStateG_Data.lower_bounds = Vec2<float>(1625, 5350);
        ...
        gStateH_Data.upper_bounds = Vec2<float>(1375, 6450);
        gStateH_Data.lower_bounds = Vec2<float>(1025, 6125);
        ...
        gStateI_Data.centre = Vec2<float>(1250, 8000);
